...
@pytest.mark.parametrize( "name,test", [
  ...
  asm_test( inst_lui.gen_imm_test         ) ,
  asm_test( inst_lui.gen_imm_dest_dep_test) ,
  asm_test( inst_lui.gen_imm_value_test   ) ,
...
@pytest.mark.parametrize( "name,test", [
  ...
  asm_test( inst_auipc.gen_imm_test         ) ,
  asm_test( inst_auipc.gen_imm_dest_dep_test) ,
  asm_test( inst_auipc.gen_imm_value_test   ) ,
