...
def gen_dest_dep_test():
  return [
    ...
    gen_sw_dest_dep_test( 5, "sw", 0x2000, 0x00010000 ),
...
def gen_srcs_dest_test():
  return [
    gen_sw_base_eq_dest_test( "sw", 0x2000, 0x01020304 ),
...
def gen_random_test():
  ...
  for i in xrange(100):
    ...
    asm_code.append( gen_sw_value_test( "sw", offset.int(), base.uint(), result ) )
