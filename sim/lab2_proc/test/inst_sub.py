...
def gen_srcs_dep_test():
  return [
    ...
    gen_rr_srcs_dep_test( 4, "sub", 11, 3,  8 ),
    gen_rr_srcs_dep_test( 3, "sub", 10, 4,  6 ),
    gen_rr_srcs_dep_test( 2, "sub",  9, 5,  4 ),
    gen_rr_srcs_dep_test( 1, "sub",  8, 6,  2 ),
    gen_rr_srcs_dep_test( 0, "sub",  7, 7,  0 ),
  ]
...
def gen_srcs_dest_test():
  return [
    ...
    gen_rr_srcs_eq_dest_test( "sub",-10, 0 ),
  ]
...
def gen_value_test():
  return [
    ...
    gen_rr_value_test( "sub", 0x00000002, 0x00000001, 0x00000001 ),
